...
def get_mag_from_mass_age(input_age, input_mass, input_distance=10., obs_filter = 'f444w'):
    ...
    bex=get_mass_vs_mag_bex(input_age, input_distance, obs_filter = 'f444w', diff='sandwich' )
    atmo=get_mass_vs_mag_atmo(input_age, input_distance, obs_filter = 'f444w', diff='sandwich' )
...
def get_mass_vs_mag_atmo(input_age, input_distance=10., obs_filter = 'f444w', diff='sandwich' ):
    ...
    for atmo_grid_file in atmo_grid_files: # file by file
        ...
        table_mags = atmo_data[header.index(instrument+'-'+obs_filter)] + 5*np.log10(input_distance/10)
